# Elyte Store RESTful API Node Server

A RESTful API back-end project for Elyte Store using [Node.js](https://nodejs.org), [TypeScript](https://www.typescriptlang.org), [Express](https://expressjs.com), and [Mongoose](https://mongoosejs.com/).
...
```bash
git clone https://github.com/elian-cheng/elyte-store.git
cd elyte-store
git checkout back
```
...
- **NoSQL database**: [MongoDB](https://www.mongodb.com/) object data modeling using [Mongoose](https://mongoosejs.com/) ODM
...
- **API documentation**: with [swagger-autogen](https://swagger-autogen.github.io/) and [swagger-ui-express](https://github.com/scottie1984/swagger-ui-express)
- **Process management**: advanced production process management using [PM2](https://pm2.keymetrics.io)
- **Dependency management**: with [npm run](https://npm run pkg.com)
...
# URL of MongoDB
DATABASE_URL="mongodb+srv://user:password@mongodb.net/mydb?schema=public"
